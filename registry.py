...
from rasa_nlu_gao.featurizers.hanlp_pseg_featurizer import PseqFeaturizer
...
from rasa_nlu_gao.tokenizers.char_tokenizer import CharTokenizer
from rasa_nlu_gao.tokenizers.whitespace_tokenizer import WhitespaceTokenizer
from rasa_nlu_gao.tokenizers.hanlp_tokenizer import HanlpTokenizer # customize
...
component_classes = [
    ...
    EntitySynonymMapper,
    SpacyFeaturizer, MitieFeaturizer, NGramFeaturizer, RegexFeaturizer, PseqFeaturizer, # customize
    CountVectorsFeaturizer,
    MitieTokenizer, SpacyTokenizer, WhitespaceTokenizer, JiebaTokenizer, HanlpTokenizer, CharTokenizer,# customize
